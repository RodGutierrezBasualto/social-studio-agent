      ...
      POST: async ({ request }) => {
        ...
        if (db && workspaceId) {
          ...
          const [ws, img, vid, buf] = await Promise.all([
            ...
            dbc.from("video_providers").select("id").eq("workspace_id", workspaceId).limit(1),
            dbc
          ...
          hasVideoProvider = ((vid?.data ?? []) as unknown[]).length > 0;
                  ...
                  generateVideo: tool({
                    ...
                    inputSchema: z.object({
                      ...
                      durationSec: z
                        ...
                        .default(8)
                        .describe("Clip length in seconds — only 4, 6 or 8 are accepted."),
                      referenceImageId: z
                        .string()
                        .default("")
                        .describe(
